...
/**
 * get_digit - convert a digit characte to a corresponding int
...
/**
 * get_prod - multiplies a string of numbers by a singlr digit
...
/**
 * add_nums - adds the number stored in 2 strings
 ...
 * number contains non-digit, the function exits with a status of 98
 *
 * Return: always 0
 */
